              ...
              <Card.Body p={4}>
                <VStack gap={3} align='stretch'>
                  ...
                  {analysis.metadata.ent_inventors && (
                    <HStack gap={1}>
                      <FiUser size={12} color='var(--chakra-colors-fg-muted)' />
          ...
          <Card.Body p={8}>
            <VStack gap={3}>
              ...
              <Text
                ...
                fontFamily='body'
              >
                No analyses are currently associated with this lab. Analyses can
                be added from the main Futurity Analysis library.
              </Text>
            </VStack>
          </Card.Body>
        </Card.Root>
