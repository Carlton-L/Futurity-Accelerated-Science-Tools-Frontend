...
const OrganizationManageDialog: React.FC<OrganizationManageDialogProps> = ({
  isOpen,
  onClose,
}) => {
  const handleContactSupport = () => {
    window.open(
      'mailto:fasthelp@futurity.systems?subject=Organization Management Request',
      '_blank'
    );
  };
          ...
          <Dialog.Body>
            <VStack gap={4} align='stretch'>
              <Text fontFamily='body' lineHeight='1.6'>
                To manage your organization settings, add new users, or modify
...
export default OrganizationManageDialog;
